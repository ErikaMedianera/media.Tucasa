                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Registro de nosotros</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <!--FORMULARIO DE REGISTRO DE PROPIEDADES-->
                                        <form id="form_nosotros" enctype="multipart/form-data" method="POST">
                                            <input type="hidden" id="id_nosotros" name="id_nosotros">
                                            <div class="mb-3">
...
<div class="modal fade" id="actualizar" tabindex="-1" aria-labelledby="actualizarLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="actualizarLabel">Actualizar nosotros</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            <form id="formularioActualizar" enctype="multipart/form-data" method="POST">
    <input type="hidden" id="id_nosotros" name="idNosotrosActualizar">
    <div class="mb-3">
        <label for="imagenActualizar" class="form-label">Imagen (opcional)</label>
        <input type="file" class="form-control" id="imagenActualizar" name="imagenActualizar">
    </div>
    <div class="mb-3">
        <label for="tituloActualizar" class="form-label">Título</label>
        <input type="text" class="form-control" id="tituloActualizar" name="tituloActualizar" required>
    </div>
    <div class="mb-3">
        <label for="descripcionActualizar" class="form-label">Descripción</label>
        <textarea class="form-control" id="descripcionActualizar" name="descripcionActualizar" required></textarea>
    </div>
